# RANDOM PROTOCOL - Cypherpunk Pokémon Team Generator

A retro-futuristic Pokémon team generator built with Next.js 14+ and Tailwind CSS, featuring a high-end cypherpunk aesthetic inspired by the Solana Cypherpunk Hackathon.

## Features

- 🎲 Generate random teams of 6 unique Pokémon (from Pokédex #1-1025)
...
- 🔍 Detailed Pokémon stats and information pages
...
- Pokémon images use `mix-blend-mode: multiply`
