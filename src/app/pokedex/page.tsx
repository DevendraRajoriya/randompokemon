...
/** Fetch full card data for the first 24 POKEMON — populates PokedexClient's initial grid via SSR */
  ...
  return (
    <>
      ...
      {/* ── SERVER-RENDERED CONTENT ──────────────────────────────
          ...
          nav links, and a full <ul> of all 1,025 POKEMON with
      ...
      <main className="min-h-screen bg-cream">
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-8 pt-8 pb-4">
          ...
          <p className="font-mono text-sm text-charcoal max-w-2xl mb-2 leading-relaxed">
            The complete National Pokédex — all <strong>{count} POKEMON species</strong> from{" "}
            ...
            Click any POKEMON to view its full stats, type matchups, evolution chain, and competitive tier.
          </p>
        ...
        {list.length > 0 && (
          <section className="max-w-7xl mx-auto px-4 md:px-8 pb-16 pt-8 border-t-4 border-black mt-8">
            <h2 className="font-grotesk font-bold text-xl text-black uppercase mb-4 border-b-2 border-black pb-2">
              Full Pokédex Index — All {count} POKEMON
            </h2>
            ...
            <div className="mt-12 pt-8 border-t-2 border-black">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <Link href="/" className="border-2 border-black p-3 hover:bg-black hover:text-cream transition-colors group">
                  ...
                  <p className="font-mono text-[10px] text-charcoal group-hover:text-cream/70">All 1025 POKEMON</p>
                </Link>
