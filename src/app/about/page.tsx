      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="font-mono text-sm text-charcoal max-w-2xl mx-auto leading-relaxed">
            The world&apos;s leading free Pokémon database and team builder — all 1,025 species across 9 generations, completely free, forever.
          </p>
        </div>
        ...
        <section className="mb-8 bg-cream border-2 border-black p-4 sm:p-6 md:p-10 slasher">
          ...
          <div className="space-y-4 font-mono text-xs md:text-sm text-charcoal leading-relaxed">
            <p className="border-l-4 border-black pl-6">
              Random Pokémon Generator was created to solve a simple problem: trainers needed a fast, free, and reliable way to generate random Pokémon teams for challenge runs, competitive preparation, and creative gameplay. Every existing tool was either paywalled, riddled with ads, slow, or limited to a handful of generations. We built the tool we always wanted — and made it free for everyone.
            </p>
            <p className="border-l-4 border-black pl-6">
              We believe Pokémon team building should be accessible to every trainer, regardless of device, location, or budget. There are no premium tiers, no paywalls, no sign-up walls, and no hidden costs — every filter, every feature, and every Pokémon is available to everyone on every visit. Our mission is to provide the most comprehensive, fast, and user-friendly Pokémon generator on the internet, permanently free.
            </p>
            <p className="border-l-4 border-black pl-6">
              Our database covers all <strong className="text-black">1,025 Pokémon</strong> across <strong className="text-black">9 generations</strong> — from Bulbasaur (#0001) through Pecharunt (#1025) — including all regional forms (Alolan, Galarian, Hisuian, Paldean variants), Mega Evolutions, Gigantamax forms, Paradox Pokémon (Iron and Ancient forms), Ultra Beasts, and all Scarlet &amp; Violet DLC additions from the Teal Mask and Indigo Disk. The database is sourced from <strong className="text-black">PokeAPI</strong> and updated within 48 hours of any new official release.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8 bg-cream border-2 border-black p-4 sm:p-6 md:p-10 slasher">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            <div className="bg-white border-2 border-black p-4 slasher">
              ...
              <p className="font-mono text-xs text-charcoal leading-relaxed">Generate random Pokémon teams of 1–6 in milliseconds. All randomisation runs client-side in your browser — no server round-trip, no lag, no wait. Results are instant every time regardless of your device or connection speed.</p>
            </div>
            <div className="bg-white border-2 border-black p-4 slasher">
              <h3 className="font-mono font-bold text-sm text-black uppercase mb-2">🌐 COMPREHENSIVE DATABASE</h3>
              <p className="font-mono text-xs text-charcoal leading-relaxed">All 1,025 Pokémon with complete base stats (HP, Attack, Defense, Sp. Atk, Sp. Def, Speed), types, abilities, height, weight, egg groups, growth rates, capture rates, and Pokédex flavor text from every game they appear in. Data sourced directly from PokeAPI.</p>
            </div>
            <div className="bg-white border-2 border-black p-4 slasher">
              <h3 className="font-mono font-bold text-sm text-black uppercase mb-2">🎯 SMART FILTERING</h3>
              <p className="font-mono text-xs text-charcoal leading-relaxed">Filter by all 18 Pokémon types, 9 regions, evolution stage (unevolved, middle, final), rarity (include or exclude Legendary, Mythical, Paradox, Ultra Beast, Sub-Legendary), and gender. Lock individual Pokémon and regenerate the rest. Every combination of filters works together instantly.</p>
            </div>
            <div className="bg-white border-2 border-black p-4 slasher">
              <h3 className="font-mono font-bold text-sm text-black uppercase mb-2">🃏 POKEMON CARD GENERATOR</h3>
              <p className="font-mono text-xs text-charcoal leading-relaxed">Create premium stat cards for any of the 1,025 Pokémon — featuring official artwork, type-matched colour gradients, full base stat bars, and ability listings. Download as high-resolution PNG (2160×2700px) for social media, printing, or sharing. Free, no watermark.</p>
            </div>
            <div className="bg-white border-2 border-black p-4 slasher">
              <h3 className="font-mono font-bold text-sm text-black uppercase mb-2">📖 COMPLETE POKÉDEX</h3>
              <p className="font-mono text-xs text-charcoal leading-relaxed">Browse all 1,025 species with full detail pages per Pokémon — base stats, type effectiveness chart (all 18 matchups), complete evolution chain, Smogon competitive tier rating, generation learnset data, and physical profile. The most complete free Pokédex available online.</p>
            </div>
            <div className="bg-white border-2 border-black p-4 slasher">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-white border-2 border-black p-4 slasher flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="font-mono text-xs text-charcoal leading-relaxed">Streamers, YouTubers, and Pokémon content creators use our generator to introduce genuinely random, unpredictable elements into their content. The live generator is engaging to watch in real time, and the Pokémon Card Generator produces high-quality, shareable graphics for thumbnails and posts.</p>
              </div>
            </div>
            <div className="bg-white border-2 border-black p-4 slasher flex gap-4 items-start">
              <span className="font-mono font-bold text-lg flex-shrink-0">✨</span>
              <div>
                ...
                <p className="font-mono text-xs text-charcoal leading-relaxed">Discover Pokémon you&apos;ve never used before and break out of your comfort zone. With 1,025 species across 9 generations, there are always overlooked gems. Many players find their new favourite Pokémon through a random roll — that&apos;s the magic of discovery.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8 bg-marigold border-2 border-black p-4 sm:p-6 md:p-10 slasher">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            <div className="bg-white border-2 border-black p-4 slasher">
              ...
              <p className="font-mono text-xs text-charcoal leading-relaxed">No premium tiers, no paywalls, no hidden costs, no freemium limits. Every Pokémon, every filter, every tool — free forever. We will never monetise features behind a subscription. This is a promise to the Pokémon community.</p>
            </div>
            <div className="bg-white border-2 border-black p-4 slasher">
            ...
            <div className="bg-white border-2 border-black p-4 slasher">
              ...
              <p className="font-mono text-xs text-charcoal leading-relaxed">Lightning-fast generation with zero unnecessary overhead. Pokémon data is cached locally so repeat visits are instant. The tool is built with Next.js and server-side rendering for fast first loads on any device, anywhere in the world.</p>
            </div>
            <div className="bg-white border-2 border-black p-4 slasher">
              <h3 className="font-mono font-bold text-sm text-black uppercase mb-1">🌍 GLOBAL ACCESSIBILITY</h3>
              <p className="font-mono text-xs text-charcoal leading-relaxed">Works on any device, any modern browser, in any country. Pokémon has no borders — neither does our tool. The site is accessible in English with full keyboard navigation and screen reader support throughout.</p>
            </div>
            <div className="bg-white border-2 border-black p-4 slasher">
            ...
            <div className="bg-white border-2 border-black p-4 slasher">
              ...
              <p className="font-mono text-xs text-charcoal leading-relaxed">Brutalist aesthetics — high contrast, sharp borders, zero visual clutter. Every design decision serves the user&apos;s goal: find a Pokémon, build a team, get out. We respect your time and your screen real estate.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8 bg-cream border-2 border-black p-4 sm:p-6 md:p-10 slasher">
          ...
          <p className="font-mono text-xs md:text-sm text-charcoal leading-relaxed border-l-4 border-black pl-6 mb-6">Our team combines decades of Pokémon experience with modern web development expertise. We are active trainers, competitive players, Nuzlocke enthusiasts, and Draft League competitors who use this tool every day — because we built the tool we always wanted to exist.</p>
          <div className="space-y-3">
            <div className="bg-white border-2 border-black p-4 slasher">
              ...
              <p className="font-mono text-xs text-marigold font-bold mb-2">Pokémon Database Architect &amp; Full-Stack Developer</p>
              <p className="font-mono text-xs text-charcoal mb-3">15+ years of Pokémon experience since Diamond and Pearl. Completed 28 mainline games including all remakes and spin-offs. Achieved a Platinum Hardcore Nuzlocke with zero deaths (2022) and Masterball tier in VGC 2024. Built the entire Random Pokémon Generator platform from scratch — database architecture, front-end, performance optimisation, and SEO.</p>
            ...
            <div className="bg-white border-2 border-black p-4 slasher">
              ...
              <p className="font-mono text-xs text-marigold font-bold mb-2">Competitive Pokémon Analyst &amp; Draft League Specialist</p>
              <p className="font-mono text-xs text-charcoal">10+ years of competitive Pokémon play. Top 500 globally on Pokémon Showdown. 8 Draft League championship titles across multiple formats. Founded the Premier Draft League — a 200+ player competitive community — and contributed the Draft League Generator&apos;s pool balancing logic and format recommendations.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8 bg-cream border-2 border-black p-4 sm:p-6 md:p-10 slasher">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-6">
            <Link href="/" className="bg-white border-2 border-black p-4 slasher hover:bg-black hover:text-white transition-all group">
              ...
              <p className="font-mono text-[10px] text-charcoal group-hover:text-white/70">All 1,025 Pokémon · Gen 1–9</p>
            </Link>
            ...
            <Link href="/pokemon-card-generator" className="bg-white border-2 border-black p-4 slasher hover:bg-black hover:text-white transition-all group">
              ...
              <p className="font-mono text-[10px] text-charcoal group-hover:text-white/70">Download HD Pokémon cards</p>
            </Link>
            ...
            <Link href="/pokemon-quiz" className="bg-white border-2 border-black p-4 slasher hover:bg-black hover:text-white transition-all group">
              ...
              <p className="font-mono text-[10px] text-charcoal group-hover:text-white/70">What Pokémon are you?</p>
            </Link>
          </div>
          <p className="font-mono text-xs text-charcoal leading-relaxed">
            Every tool on <strong className="text-black">randompokemon.co</strong> is built with the same principles: fast, free, no account required, and mobile-friendly. Whether you need a <Link href="/shiny-pokemon-generator" className="text-black underline font-bold">Shiny Pokémon Generator</Link>, a <Link href="/legendary-pokemon-generator" className="text-black underline font-bold">Legendary Generator</Link>, or regional generators for <Link href="/kanto-pokemon-generator" className="text-black underline font-bold">Kanto</Link>, <Link href="/johto-pokemon-generator" className="text-black underline font-bold">Johto</Link>, <Link href="/hoenn-pokemon-generator" className="text-black underline font-bold">Hoenn</Link>, <Link href="/sinnoh-pokemon-generator" className="text-black underline font-bold">Sinnoh</Link>, <Link href="/unova-pokemon-generator" className="text-black underline font-bold">Unova</Link>, <Link href="/kalos-pokemon-generator" className="text-black underline font-bold">Kalos</Link>, <Link href="/alola-pokemon-generator" className="text-black underline font-bold">Alola</Link>, <Link href="/galar-pokemon-generator" className="text-black underline font-bold">Galar</Link>, or <Link href="/paldea-pokemon-generator" className="text-black underline font-bold">Paldea</Link> — every tool is one click away.
          </p>
        </section>
        ...
        <section className="text-center bg-black border-4 border-black p-12 slasher mb-8">
          ...
          <p className="font-mono text-marigold text-sm mb-8 max-w-xl mx-auto">Thousands of trainers worldwide trust Random Pokémon Generator for Nuzlockes, Draft Leagues, and team discovery. Start generating teams today. Free forever.</p>
