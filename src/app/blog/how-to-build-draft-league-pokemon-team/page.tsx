...
export const metadata: Metadata = {
  title: "How to Build a Draft League POKEMON Team | Strategy Guide",
  description: "Draft order strategy, tier valuation, role coverage, win conditions, and counter-drafting — a full system for dominating your POKEMON Draft League season.",
  ...
  openGraph: { title: "How to Build a Draft League POKEMON Team", description: "Complete draft order strategy, tier valuation, and team building system for POKEMON Draft Leagues.", type: "article", url: "https://www.randompokemon.co/blog/how-to-build-draft-league-pokemon-team", images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "How to Build a Draft League Pokemon Team" }] },
  twitter: { card: "summary_large_image", title: "How to Build a Draft League POKEMON Team", description: "Complete draft order strategy, tier valuation, and team building system for POKEMON Draft Leagues.", images: ["/og-image.png"] },
    ...
    <main className="min-h-screen bg-cream">
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-8 md:py-12">
        ...
        <section className="mb-10">
          <h2 className="font-grotesk font-bold text-2xl text-black uppercase mb-4">What Is a POKEMON Draft League?</h2>
        ...
        <section className="mb-10">
          ...
          <p className="font-mono text-sm text-charcoal leading-relaxed mb-6">Before you draft a single POKEMON, internalise these roles. A complete team covers at least 5 of these 7 functions — the other 2 can be handled by overlap.</p>
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="bg-white border-2 border-black p-4">
              ...
              <p className="font-mono text-xs text-charcoal leading-relaxed">Set sun, rain, sand, or snow. Your whole team synergises with one weather condition. Works if you draft well around the setter — three or more POKEMON that benefit from the weather makes this win condition self-consistent and difficult to disrupt.</p>
            </div>
            <div className="bg-white border-2 border-black p-4">
              <p className="font-mono font-bold text-xs text-black uppercase mb-2">Trick Room</p>
              <p className="font-mono text-xs text-charcoal leading-relaxed">Slow, high-power POKEMON attack first under Trick Room. Counters many speed-based strategies when executed cleanly. Requires at least two Trick Room setters to prevent the strategy from collapsing if the primary setter is removed early.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-3">
            <div className="border-2 border-black p-4">
              <h3 className="font-mono font-bold text-sm text-black mb-2">What is the best POKEMON to draft first overall?</h3>
              <p className="font-mono text-xs text-charcoal leading-relaxed">In most draft pools, the best first-overall pick is either a high-BST wallbreaker (Garchomp, Dragapult, Iron Valiant) or a hazard setter that doubles as an offensive threat (Great Tusk, Glimmora). The key is picking a POKEMON that defines your team identity and forces opponents to react to you, rather than the reverse.</p>
            </div>
            <div className="border-2 border-black p-4">
              <h3 className="font-mono font-bold text-sm text-black mb-2">How many POKEMON are drafted per team?</h3>
              <p className="font-mono text-xs text-charcoal leading-relaxed">Most leagues draft 10–12 POKEMON per team, with players selecting 6 for each individual match. The larger roster allows you to prepare different team compositions for specific opponents throughout the season, which is one of the most important strategic layers of Draft League that beginners often overlook.</p>
            </div>
            <div className="border-2 border-black p-4">
              <h3 className="font-mono font-bold text-sm text-black mb-2">What is counter-drafting in POKEMON Draft League?</h3>
