...
// Generate Pokemon list (1-1025) with basic data
// Types will be fetched client-side for detailed view, but this provides SSR content
...
// Basic Pokemon names for Gen 1-9 (for SSR)
function getPokemonName(id: number): string {
  ...
  // Return known name or generate a placeholder
